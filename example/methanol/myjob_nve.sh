...
#    sleep 10
    ...
    # NPT EQUILIBRATION #
    #####################
# $GMX/gmx grompp -f npt.mdp -c nvt_methanol.gro -p methanol.top -o npt_methanol.tpr
# $GMX/gmx mdrun -deffnm npt_$SOLVENT
    #################
    # NVE PRODUCTION MD #
    #################
 $GMX/gmx grompp -f nve.mdp -c nvt_methanol.gro -p methanol.top -o nve_methanol.tpr
 $GMX/gmx mdrun -deffnm nve_$SOLVENT
    # End
